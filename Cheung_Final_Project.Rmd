...
###COVID Mapping
zipcode_dir <- "COVID Maps/harris-county-tx-zipcodes.shp"
zipcode <- readOGR(zipcode_dir, verbose = FALSE)
zipcode_projected <- spTransform(zipcode, CRS(new_crs))

COVID_cases <- read.csv("COVID Maps/COVID-19 Active Cases Data by Zip Code_as of 4.24.22.csv")
