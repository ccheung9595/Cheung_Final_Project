...
svi_dir <- "C:/Users/ccheung/OneDrive - Greater Houston Community Foundation/Desktop/Chelsea - R/Final Project/tl_2019_48_tract.shp"
svi <- readOGR(svi_dir, verbose = FALSE)
new_crs <- '+init=epsg:4326'
svi_projected <- spTransform(svi, CRS(new_crs))


svi_data <- read.csv("SVI and COVID Data/Texas.csv")
#svi_data <- read_excel("Texas.xls")
...
###COVID Mapping
zipcode_dir <- "C:/Users/ccheung/OneDrive - Greater Houston Community Foundation/Desktop/Chelsea - R/Final Project/harris-county-tx-zipcodes.shp"
zipcode <- readOGR(zipcode_dir, verbose = FALSE)
zipcode_projected <- spTransform(zipcode, CRS(new_crs))

COVID_cases <- read.csv("SVI and COVID Data/COVID-19 Active Cases Data by Zip Code_as of 4.24.22.csv")
#COVID_cases <- read_excel("COVID-19 Active Cases Data by Zip Code_as of 4.24.22.xls")
